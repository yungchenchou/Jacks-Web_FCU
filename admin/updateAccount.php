...
if(isset($_SESSION['username'])){
	...
	$uResearch = isset($_POST['inputResearch'])?htmlspecialchars($_POST['inputResearch'],ENT_QUOTES):"";
	
	$sql = "UPDATE user SET `userName`='$cName', `userEName`='$eName', `userEmail`='$uEmail',
	           `userPhone`='$uPhone', `userAddress`='$uAddress', `userPosition`= '$uPosit' , `userResearch`= '$uResearch' WHERE `userID` = '$uID'";
