		...
		<div class="container">
			...
			<form class="form-horizontal" role="form" method="post" action="updateAccount.php">
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input class="form-control" name="inputAccount" id="focusedInput" type="text" value="<?php echo $row[0];?>" readonly>
					</div>
				...
				<div class="form-group">
					<label for="inputResearch" class="col-sm-4 control-label">Research:<font color=red>*</font></label>
					<div class="col-sm-4">
						<textarea class="form-control" rows="3" id="inputResearch" name="inputResearch"><?php echo $row[8];?></textarea>
					</div>
					<div class="col-sm-3"></div>
				</div>
				<div class="form-group">
