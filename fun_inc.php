		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav" style="font-size: 1.3em; font-family: '微軟正黑體'">
				<li <?php if($flag == 1) echo "class=\"active\"";?>>
					...
					<span class="glyphicon glyphicon-home" aria-hidden="true"></span> 首頁</a></li>
				<li <?php if($flag == 2) echo "class=\"active\"";?>>
					<a href="<?php echo $url;?>vita.php">
					<span class="glyphicon glyphicon-book" aria-hidden="true"></span> 簡歷</a></li>
				<li <?php if($flag == 3) echo "class=\"active\"";?>>
					<a href="<?php echo $url;?>acdmActivites.php">
					<span class="glyphicon glyphicon-font" aria-hidden="true"></span> 學術</a></li>
				<li <?php if($flag == 4) echo "class=\"active\"";?>>
					<a href="<?php echo $url;?>pubList.php">
					<span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> 著作</a></li>
				<li <?php if($flag == 5) echo "class=\"active\"";?>>
					<a href="<?php echo $url;?>courses.php">
					<span class="glyphicon glyphicon-education" aria-hidden="true"></span> 教學</a></li>
				<li <?php if($flag == 6) echo "class=\"active\"";?>>
					<a href="<?php echo $url;?>students.php">
					<span class="glyphicon glyphicon-user" aria-hidden="true"></span> 徒弟</a></li>
				<li <?php if($flag == 7) echo "class=\"active\"";?>>
					<a href="<?php echo $url;?>favLink.php">
					<span class="glyphicon glyphicon-link" aria-hidden="true"></span> 有用連結</a></li>
<!--				<li><a href="--><?php //echo $url1;?><!--dokuwiki/">-->
<!--					<span class="glyphicon glyphicon-leaf" aria-hidden="true"></span> 讀庫</a></li>-->
<!--				<li><a href="--><?php //echo $url;?><!--wordpress">-->
<!--					<span class="glyphicon glyphicon-heart" aria-hidden="true"></span> 璞學部落</a></li>-->
<!--				<li><a href="--><?php //echo $url2;?><!--moodle">-->
<!--					<span class="glyphicon glyphicon-apple" aria-hidden="true"></span> 魔課</a></li>-->
			</ul>
