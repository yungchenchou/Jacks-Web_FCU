...
<body>
    ...
    <div class="container">
        <h2>1091 HTML 5 Web APP 設計與開發<br />(Design and Development of HTML 5 Web APP)</h2>
        <div id="row">
            <ul style="display:inline-block; ">
                <li class="btn">
                    <a class="btn btn-primary" href="http://210.70.80.21/~yungchen/1091-webapp/1091-webapp-outcome.php"> 學生作品 </a></li>
                <li class="btn">
