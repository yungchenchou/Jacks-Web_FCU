...
<div class="container">
    ...
    <div class="sub-nav">
        <ul class="favLink">
            <li><a href="http://120.108.117.245/~jackjow/WebDemo/index1.php" target="_blank">學生作品</a></li>
    ...
    <div class="tab-content">
        ...
        <div id="home" class="tab-pane fade in active">
            ...
            <table class="course">
                ...
                <tr>
                    <td>03</td>
                    <td><a href="https://youtu.be/3EIygDMBgUU" target="_blank">PhpStorm 使用 GitHub Desktop 及 WebServer 連結</a>
