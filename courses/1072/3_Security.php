...
<body>
    ...
    <div class="container">
        <h2>107-2 數位內容資訊安全 (Digital Content Information Security)</h2>
        <h3 style="text-shadow: 2px 2px 4px rgb(80, 80, 80); color: rgb(0,0,0);">
            時間: 週三 567(13:10~16:00) 地點: 資訊大樓 H103 室</h3>
        <ol style='padding: 0 0 1.3em 2.5em;'>
            <li style='font-size: 1.3em;'><a href="https://www.books.com.tw/products/0010744784">資訊與網路安全實務</a>
            資訊與網路安全實務, 黃明祥, 林詠章, 周永振/編著, 高立圖書, ISBN：9789865917883</li>
